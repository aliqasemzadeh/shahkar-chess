<flux:modal name="administrator.game-management.edit.modal" variant="flyout" position="left">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('jetadmin.edit_game') }}</flux:heading>
            <flux:text class="mt-2">{{ __('jetadmin.edit_game_description') }}</flux:text>
        </div>
        ...
        <form wire:submit="edit">
            ...
            <div class="flex justify-end space-x-3 mt-6">
                <flux:button
                    type="button"
                    variant="primary"
                    wire:click="$dispatch('modal-close', { name: 'administrator.game-management.edit.modal' })">
                    {{ __('jetadmin.cancel') }}
                </flux:button>
