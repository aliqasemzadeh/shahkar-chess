...
<flux:navlist variant="outline">
    ...
    @can('administrator_user_management')
        <flux:navlist.group heading="{{ __('jetadmin.user_management') }}" class="grid" expandable :expanded="request()->routeIs('administrator.user-management.*')">
    ...
    @endcan
        @can('administrator_content_management')
            <flux:navlist.group heading="{{ __('jetadmin.content_management') }}" class="grid" expandable  :expanded="request()->routeIs('administrator.content-management.*')">
        ...
        @can('administrator_setting_management')
            <flux:navlist.group heading="{{ __('jetadmin.setting_management') }}" class="grid" expandable  :expanded="request()->routeIs('administrator.setting-management.*')">
